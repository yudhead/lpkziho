...
<div class="container mt-5">
    <h1>Manage Informasi Pages</h1>
    <a href="{{ route('admin.informasi-page.create') }}" class="btn btn-primary mb-3">Create New Page</a>
        ...
        @foreach ($informasi_pages as $page)
            <li class="list-group-item page-item" data-id="{{ $page->id }}">
                ...
                <div class="page-actions">
                    <a href="{{ route('admin.informasi-page.edit', $page->id) }}" class="btn btn-secondary btn-sm mr-2">Edit</a>
                    <form action="{{ route('admin.informasi-page.destroy', $page->id) }}" method="POST" style="display: inline-block;">
                        @csrf
                        @method('DELETE')
