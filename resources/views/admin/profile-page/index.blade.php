...
<div class="container mt-5">
    <h1>Manage Profile Pages</h1>
    <a href="{{ route('admin.profile-page.create') }}" class="btn btn-primary mb-3">Create New Page</a>
        ...
        @foreach ($profile_pages as $page)
            <li class="list-group-item page-item" data-id="{{ $page->id }}">
                ...
                <div class="page-actions">
                    <a href="{{ route('admin.profile-page.edit', $page->id) }}" class="btn btn-secondary btn-sm mr-2">Edit</a>
                    <form action="{{ route('admin.profile-page.destroy', $page->id) }}" method="POST" style="display: inline-block;">
                        @csrf
                        @method('DELETE')
